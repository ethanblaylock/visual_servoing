...
class IbvsEih(object):
    ...
    def _command_velocity(self,vel):
        ...
        baxter_vel = self._baxter.cam_to_body(vel)
    ...
    def set_target(self,final_camera_depth,desired_corners):
        ...
        self._visual_servo.set_target(ideal_cam_pose,None,ideal_corners=desired_corners)
    def move_to_position(self,final_camera_depth,desired_corners,dist_tol):
        ...
        while not rospy.is_shutdown():
            ...
            servo_vel = self._visual_servo.get_next_vel(corners=marker_corners, depths=self._apriltag_client.depths)
